  ...
  <div class="w-5/6">
    <div class="w-full grid grid-cols-1 md:grid-cols-5">
      ...
      <div class="text-left col-span-2 flex flex-col h-full my-5 mr-10">
        <p class="text-5xl flex items-center"><img src="/img/airplanner_logo.png" class="w-14 h-14 items-center" alt="airplanner logo" /><span class="text-blue-500">Air</span><span class="text-white">Plan</span><span class="text-red-500">ner</span></p>
      ...
      <div class="text-left flex flex-col h-full mt-5">
        ...
        <ul>
          <li><a class="md:hover:text-blue-800 dark:md:hover:text-blue-300 transition duration-300 ease-in-out" href="https://github.com/benjaminpmd/AirPlanner">Github</a></li>
        </ul>
        ...
        <ul>
          ...
          <li><a class="md:hover:text-blue-800 dark:md:hover:text-blue-300 transition duration-300 ease-in-out" href="https://github.com/aaaakkkkk1">Xuming M</a></li>
        </ul>
      </div>
